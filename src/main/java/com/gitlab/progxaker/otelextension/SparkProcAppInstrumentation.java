...
public class SparkProcAppInstrumentation implements TypeInstrumentation {
  ...
  public void transform(TypeTransformer transformer) {
    ...
    */
    transformer.applyAdviceToMethod(
        named("$anonfun$waitThread$1"), this.getClass().getName() + "$AnonFunctionAdvice");

    // Scala "org.apache.livy.utils.SparkApp$State$Value" translates to Java
  ...
  public static class ChangeStateAdvice {
    ...
    public static void onExit(
        @Advice.FieldValue("state") Object finalState, @Advice.Argument(0) Object specifiedState) {
      /*
